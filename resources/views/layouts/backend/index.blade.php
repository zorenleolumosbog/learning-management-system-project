...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        ...
        <span class="navbar-brand-text hidden-xs-down"> System</span>
      </div>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a href="javascript:void(0)">Learning Management System. All Rights reserved</a></div>
  </footer>
  <!-- Core  -->
