    		...
    		<div class="form-group col-md-4">
	            ...
	            <label class="cabinet center-block">
	                <figure class="course-image-container">
	                    ...
	                    <img src="@if(Storage::exists($instructor->instructor_image)){{ Storage::url($instructor->instructor_image) }}@else{{ asset('backend/assets/images/user.jpg') }}@endif" class="gambar img-responsive" id="course_image-output" name="course_image-output" />
